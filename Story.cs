...
namespace InteractiveFiction
{
    internal class Story
    {
        public static string[] story = new string[] 
        {
            ...
            "After a long life of adventuring you have chosen to retire to an island to farm. One day you hear the sound of people approaching.%Investigate the sounds. %Return to your modest hut and hide. %2 %3",
            ...
            "The sword, so long hidden away, flies to your hand. It's true home.%Your enemies fall before you, as they always have.%Continue.%Continue.",
            "Congrats, you've beaten the game through the power of violence! %Start Again?% Exit.%"
        };
    }
}
