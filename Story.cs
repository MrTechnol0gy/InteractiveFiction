...
namespace InteractiveFiction
{
    internal class Story
    {
        public static string[] story = new string[] 
        {
            ...
            "You head to your home and close the curtains. It's not long before you hear loud voices outside. They shout for you to come out.%%A: Nothing good can come from this. Refuse to leave. (Go To Page Four) %D: You sigh and head out to face them. (Go To Page Five).%",
            "This is a fourth test of the emergency story system.%Choice One%Choice Two%Page Number%Page Number%",
