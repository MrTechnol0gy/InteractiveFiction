...
namespace InteractiveFiction
{
    internal class Story
    {
        public static string[] story = new string[] 
        {
            ...
            "You didn't retire to deal with this. You can always start again, somewhere farther away. %Start Again? %Exit.%1 %1",
            "The bandits return quietly in the night and light your home on fire, with you in it. You die. %Start Again? %Exit. %1 %1",
            ...
            "Congrats, you've beaten the game through the power of violence! %Start Again?% Exit.%1 %1"
        };
    }
}
